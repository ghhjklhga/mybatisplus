package com.ways.demo.mybatisplus.util;
...
public class MysqlGenerator {
    ...
    private static final String URL = "jdbc:mysql://47.112.35.237:3306/test_mybatis_plus?useUnicode=true&characterEncoding=UTF-8";
